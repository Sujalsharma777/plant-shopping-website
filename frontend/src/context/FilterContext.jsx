...
const ProductList = () => {
    ...
    if (isLoading) {
        return <p className="text-center text-xl my-5">Loading...</p>;
    }
        ...
        <section className="m-5">
            ...
            <div className="my-5 grid grid-cols-1 sm:grid-cols-4 gap-8 *:flex *:flex-col *:items-center">
                {filter_products.map((data) => (
                    <div
                        className="text-center relative shadow-gray-400 shadow-md rounded-2xl p-5"
                        key={data.id}
                    >
                        ...
                        <NavLink
                            ...
                            className="w-full p-2 my-3 bg-green-700 text-white rounded-sm"
                        >
                            View
                        </NavLink>
                    </div>
